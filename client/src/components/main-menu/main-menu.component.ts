  ...
  private getHtml() {
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a click="this.copy()" class="nav-link ${this.view.model.hasSelectedItems() ? '' : 'disabled'}" href="#">
            Copy</a>
          </li>
          <li class="nav-item">
            <a click="this.delete()" class="nav-link ${this.view.model.hasSelectedItems() ? '' : 'disabled'}" href="#">
            Delete</a>
          </li>
        </ul>
      </div>
